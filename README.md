...
- 🔗 **Live Demo:** [library-management-system-u7rv.onrender.com](https://library-management-system-u7rv.onrender.com/) (Note: On the free tier, the initial page load can take 30-60 seconds to wake up the server from a cold state).
