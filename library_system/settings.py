...
# Active translation and timezone awareness
USE_I18N = True
USE_TZ = True
...
# Configure static and default files storage
if DEBUG:
    STORAGES = {
        "default": {
...
# Redirect login/logout settings
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'catalog:book_list'
LOGOUT_REDIRECT_URL = 'login'

# Email backend for testing password reset via console
